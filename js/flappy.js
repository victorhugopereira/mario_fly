...
function Mario(alturaJogo) {
    ...
    this.animar = () => {
        ...
        if(voando == true){
            this.elemento.src = 'imgs/mariovoando.gif'
        }else if(voando == false){
            this.elemento.src = 'imgs/mariocaindo.png'
        }
...
function colisao(mario, barreiras) {
    let colisao = false
    barreiras.pares.forEach(parDeBarreiras => {
        if (!colisao) {
            const superior = parDeBarreiras.superior.elemento
            const inferior = parDeBarreiras.inferior.elemento
            colisao = estaoSobrepostos(mario.elemento, superior)
